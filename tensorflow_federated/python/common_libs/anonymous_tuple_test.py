...
class AnonymousTupleTest(absltest.TestCase):
  ...
  def test_equality(self):
    ...
    self.assertTrue(foo1.__eq__(foo1))
    self.assertEqual(foo1.__eq__(1), NotImplemented)
    self.assertTrue(foo1.__eq__(foo1_eq_clone))
    self.assertTrue(foo1_eq_clone.__eq__(foo1))
    self.assertFalse(foo1.__eq__(foo1_eq_order))
    self.assertFalse(foo1_eq_order.__eq__(foo1))
    self.assertFalse(foo1.__eq__(foo1_ne_value))
    self.assertFalse(foo1_ne_value.__eq__(foo1))
    self.assertFalse(foo1.__ne__(foo1))
    self.assertEqual(foo1.__ne__(1), NotImplemented)
    self.assertFalse(foo1.__ne__(foo1_eq_clone))
    self.assertFalse(foo1_eq_clone.__ne__(foo1))
    self.assertTrue(foo1.__ne__(foo1_eq_order))
    self.assertTrue(foo1_eq_order.__ne__(foo1))
    self.assertTrue(foo1.__ne__(foo1_ne_value))
    self.assertTrue(foo1_ne_value.__ne__(foo1))
